...
class TransferSpeedCalculator(QObject):
    ...
    def update_speed(self):
        ...
        if elapsed_time > 0:
            speed = self.bytes_sent / elapsed_time
    ...
    def calculate_average_speed(self):
        elapsed_time = time.time() - self.start_time
        if elapsed_time > 0:
            average_speed = self.bytes_sent / elapsed_time
            average_speed_str = f"Average Speed: {average_speed / 1024:.2f} KB/s"
            self.speed_updated.emit(average_speed_str)

    def update_bytes_sent(self, bytes_sent):
...
class FileTransferWindow(QMainWindow):
    def __init__(self):
        ...
        self.speed_calculator = TransferSpeedCalculator()
        ...
        self.speed_label = QLabel("Transfer Speed: 0 KB/s")
        ...
        # Connect speed update signal
        self.speed_calculator.speed_updated.connect(self.update_speed_label)
        ...
        try:
            ...
            with open(self.file_path, 'rb') as f:
                ...
                while True:
                    ...
                    self.speed_calculator.update_bytes_sent(bytes_sent)
